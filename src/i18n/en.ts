...
const en = {
  ...
  // --- Camera params ---
  "camera.type.title": "Camera type",
  "camera.type.perspective": "Perspective camera",
  "camera.type.orthographic": "Orthographic camera",
  "camera.params.title": "Camera parameters",
  "camera.near": "Near clipping plane",
  "camera.far": "Far clipping plane",
  "camera.aspect": "Render aspect ratio",
  "camera.renderArea": "Render area",
  "camera.aspectPreview.mode": "Preview mode",
  ...
  "camera.help.type.title": "Camera type",
  "camera.help.type.body":
    "Perspective mimics a real lens with depth. Orthographic removes perspective distortion—useful for technical views and UI.",
  "camera.help.presets.title": "Camera presets",
  "camera.help.presets.body":
    "Standard views snap the camera to common angles. Save current view stores your custom framing; use the button at the bottom.",

  "light.type.title": "Light source type",
  "light.type.ambient": "Ambient light",
  "light.type.spot": "Directional light",
  "light.type.hdri": "Background light (HDRI)",
  "light.params.title": "Parameters {name}",
  "light.intensity": "Intensity",
  "light.distance": "Falloff distance",
  "light.penumbra": "Penumbra strength",
  "light.angle": "Spread angle",
  "light.target": "Target direction",
  "light.target.placeholder": "Select a Figma variable",
  "light.presets.title": "Lighting presets",
  "light.preset.soft": "Soft",
  "light.preset.hard": "Hard",
  "light.preset.flat": "Stylized flat",
  "light.hdriPreset.title": "HDRI presets",
  "light.hdriPreset": "HDRI preset",
  "light.help.type.title": "Light source type",
  "light.help.type.body":
    "Ambient fills the scene evenly. Directional light works like a spotlight. HDRI uses an environment map for image-based lighting.",
  "light.help.presets.title": "Lighting presets",
  "light.help.presets.body":
    "Quickly adjust penumbra and cone angle for common lighting styles.",
  "light.help.hdri.title": "HDRI presets",
  "light.help.hdri.body":
    "Choose an environment map for reflections and ambient lighting.",
